            ...
            >
              ...
              >
                <div className="z-10 flex flex-col items-center justify-center h-screen cursor-pointer">
                  <span className="lg:text-xl font-custom duration-150 xl:text-5xl text-white group-hover:text-primary font-display cursor-pointer">
                    {s.handle}
                  </span>
                  <span className="mt-4 text-5xl text-center duration-1000 text-white group-hover:text-primary cursor-pointer">
                    {s.label}
                  </span>
                </div>
              </Link>
